                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-red-400 italic ">
                      ""Your technical explanation lacked depth and clarity. Strengthen your  <br />
                       understanding of core concepts and support your answers with specific examples.""
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-emerald-400 italic">
                      ""Great improvement in communication and self-presentation.<br /> Your responses were structured, confident, and aligned with the role.""
                    </div>
                  </div>
                </div>
              </div>
