...
const Home = () => {
  ...
  "
          ...
          <div className="bg-[#E6F0FA] px-0 py-12">
            ...
            <div className="mb-20 px-12">
  <h2 className="text-black font-bold text-3xl mb-16">
...
Expert in assessing emotional intelligence, team dynamics, and authenticity in candidates.`,
      ...
      <div
        key={i}
        className="bg-[#daecf9] border border-black rounded-3xl p-6 
                   flex w-[650px] min-h-[260px] shadow-md"
      >
        {/* LEFT—Gradient Circle with Image */}
        <div className="flex flex-col justify-center mr-6">
          <div
            className={`w-36 h-36 rounded-full ${person.color} 
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-gray-600 text-sm mb-3">{person.subtitle}</p>
          <p className="text-black text-sm leading-5 whitespace-pre-line">
            {person.desc}
          </p>
        </div>
      </div>
